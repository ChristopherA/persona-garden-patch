...
**Link markers:**
- *(no marker)* — **Grafted** from source garden, navigable here
...
- [\[\[The Persona Spectrum from Role Label to Soul Document\]\]](models/The%20Persona%20Spectrum%20from%20Role%20Label%20to%20Soul%20Document.html) — Five-level progression from simple role labels to comprehensive identity documents
- [\[\[SoulSpec Portable Agent Identity Standard\]\]](models/SoulSpec%20Portable%20Agent%20Identity%20Standard.html) — Open standard for portable agent identity across frameworks
- [\[\[Character Cards as Community-Evolved Persona Specification\]\]](models/Character%20Cards%20as%20Community-Evolved%20Persona%20Specification.html) — How roleplay communities evolved sophisticated persona specifications
...
- [\[\[Role Prompting Improves Style but Not Accuracy\]\]](patterns/Role%20Prompting%20Improves%20Style%20but%20Not%20Accuracy.html) — Role prompts shape behavioral style effectively but do not improve factual accuracy
- [\[\[Persona Specialization Beats Generalization in Multi-Step Work\]\]](patterns/Persona%20Specialization%20Beats%20Generalization%20in%20Multi-Step%20Work.html) — Specialized personas outperform generalists on complex multi-step tasks
...
- [\[\[Garden Patch as Composable Knowledge Fragment\]\]](glosses/Garden%20Patch%20as%20Composable%20Knowledge%20Fragment.html) — What a garden patch is and how it works as a portable knowledge unit
- [\[\[Structural Contract as Form Type Agreement\]\]](glosses/Structural%20Contract%20as%20Form%20Type%20Agreement.html) — The agreement every instance of a form type follows
- [\[\[Garden Precinct\]\]](glosses/Garden%20Precinct.html) — The curated knowledge zone with structural contracts and growth stages
- [\[\[Household Precinct\]\]](glosses/Household%20Precinct.html) — The operational knowledge zone with lighter conventions
- [\[\[Deep Context Graph Vocabulary\]\]](glosses/Deep%20Context%20Graph%20Vocabulary.html) — Reference for graph terms, predicates, and classification system
- [\[\[Grafted Node as Transplanted Knowledge in a Garden Patch\]\]](glosses/Grafted%20Node%20as%20Transplanted%20Knowledge%20in%20a%20Garden%20Patch.html) — How nodes are copied from a source garden into a patch
- [\[\[Patch-Native Node as Original Knowledge in a Garden Patch\]\]](glosses/Patch-Native%20Node%20as%20Original%20Knowledge%20in%20a%20Garden%20Patch.html) — Nodes born in a patch, marked with ⊙
- [\[\[Upstream Node as Source Garden Reference\]\]](glosses/Upstream%20Node%20as%20Source%20Garden%20Reference.html) — References to source garden nodes not included in the patch
...
- Garden Node
- Ghost Link as Unplanted Garden Stake|Ghost links
- Grafted Node as Transplanted Knowledge in a Garden Patch|Grafted nodes
...
- Parent Note
- Party
- Patch-Native Node as Original Knowledge in a Garden Patch|Patch-native nodes
- Patch-Native Node as Original Knowledge in a Garden Patch|patch-native nodes
- Person
- Person Name
...
- Source
- Source Document
- Structural Contract as Form Type Agreement|structural contract
- Structural Contract as Form Type Agreement|structural contracts
- Target
- Ted Nelson
- The Gardening Problem Returns
- Upstream Node as Source Garden Reference|upstream nodes
- Value
- brackets
- target
