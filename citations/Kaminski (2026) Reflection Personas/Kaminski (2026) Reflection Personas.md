...
citation_slug: kaminski-2026-reflection-personas
publication_year: 2026
canonical: ""
brief_summary: "A collection of 27 AI reflection personas spanning professional, cultural, linguistic, and temporal perspectives, designed as analytical lenses for course session reflection. Includes addenda deepening three personas with named analytical frameworks (Bourdieu, Knowles, Rosenfeld-Morville), demonstrating that framework grounding produces genuine perspective divergence where topic labeling produces convergence."
tagline: "27 analytical lenses showing that frameworks, not topic labels, produce genuine persona divergence"
---
...
- cites_work_by::[[Peter Kaminski]]↑
- cites_work_by::[[Victoria Gracia]]↑

# Kaminski (2026) Reflection Personas

## Bibliographic Entry

* _**Reflection Personas**_ (2026). [unpublished collection]. _Kaminski, Peter; Gracia, Victoria._ Built primarily by Claude Opus 4.6, with some material from ChatGPT 5.4 Thinking. 32 files: 1 overview, 27 persona definitions, 4 addenda. Shared privately, March 2026.
...
> "The goal is **not** pastiche, mimicry, or role-play for its own sake. The goal is to use **genuinely different analytical frameworks** to notice things a single perspective would miss."
> — Overview

> "These personas aren't very deep — they just tell Claude how to act, and it does it out of its general training. Contrast that with a Toki Pona tool / persona that Victoria Gracia has, where that persona has a collection of curated knowledge about Toki Pona culture and language, on top of general training."
> — Overview
...
> "The three Week 1 reflections (neutral, anthropologist, toki pona) cover the same 5-6 themes and converge on similar conclusions. They illuminate different corners of the same room, but they don't see different rooms. The toki pona reflection is the exception: it works precisely because the language itself *is* a framework."
> — Addenda overview

> "Choosing the right framework for a persona is not a neutral act. It requires knowing a field well enough to identify which of its many frameworks best fits the material at hand."
> — Addenda overview

> "Is Claude Code a democratizing force or a new form of capital? If only those who already have technical capital can use it effectively, it reinforces the hierarchy it claims to flatten."
> — Addenda - Anthropologist (Bourdieu framing)

> "No persona gets a specific gender unless that gender strengthens the lens."
> — Overview, gender design section
...
- relates_to::[Agentic Architecture](../../domains/Agentic%20Architecture.html)
  - Persona design is a named sub-area of the Agentic Architecture domain. This collection extends the domain's coverage of multi-agent coordination patterns.

- relates_to::[Agreement is a Bug - Structured Disagreement Through 11 Agent Personas (@nyk_builderz)](../nyk_builderz%20%282026%29%20Council%20of%20High%20Intelligence%20Structured%20Disagreement/Renditions/Agreement%20is%20a%20Bug%20-%20Structured%20Disagreement%20Through%2011%20Agent%20Personas%20%28@nyk_builderz%29.html)
  - The adversarial council approach (polarity pairs, cross-examination protocol, convergence gates) contrasts with the analytical-lens approach (independent reflection, no inter-persona protocol, human-performed convergence).

- relates_to::[[Archetype Anchoring Approach for Estate Personas]]↑
  - The estate's archetype-anchored personas operate at the framework constraint level. The Reflection Personas hierarchy (structural > framework > topic) suggests that expression constraints could further differentiate estate personas.
