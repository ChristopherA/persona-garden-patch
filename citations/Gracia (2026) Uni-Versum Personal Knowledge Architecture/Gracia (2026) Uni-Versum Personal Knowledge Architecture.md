...
# Gracia (2026) Uni-Versum Personal Knowledge Architecture

## Bibliographic Entry

* _**Uni-Versum**_ (2026). [web article]. _Gracia, Victoria._ 54-page web site including 8 narrative argument pages, 3 vocabulary indexes, 12 schema vocabulary terms, 29 domain vocabulary terms, and 2 JSON-LD indexes. Retrieved 2026-03-30 from: <https://uni-versum.me/>
...
- _**Uni-Versum**_. Victoria Gracia. <https://uni-versum.me/> — primary source (54 pages)
- [[Victoria Gracia]]↑ — person note with meeting history and collaboration context
- [[2026-03-26 Peter Kaminski - Garden Patches and Personas]]↑ — meeting where Victoria shared the vocabulary page
...
- relates_to::[[Progressive Trust]]↑
  - Autonomia may be a specialization of progressive trust applied to agent delegation: trust develops through successful graduated delegation.

- relates_to::[[Persona Design Choices Across Analytical Cultural and Professional Axes]]↑
  - The agent taxonomy (agens-humanus, agens-scriptum, agens-scriptum-loquens) provides classification vocabulary for the five persona approaches. Cultural reflection personas operate through agens-scriptum-loquens with high autonomia in reflective contexts.

- relates_to::[[Orchestrator-Worker Separation in Personal Multi-Agent Systems]]↑
  - Uni-Versum's agent model does not distinguish orchestrators from workers. The estate's coordination hierarchy and Uni-Versum's interface-modality hierarchy are complementary, not competing.

- relates_to::[Deep Context Architecture](../../domains/Deep%20Context%20Architecture.html)
  - Uni-Versum builds a personal knowledge architecture from semantic web standards. Deep Context Architecture builds from garden forms and typed predicates. Both target the same gap (meaning above information) through different implementation stacks.

- relates_to::[[Sovereignty Is Selective Permeability Not Absolute Control]]↑
  - The membrane metaphor (workspace boundary as selective barrier, not wall) aligns with sovereignty-as-permeability. Diploma formalizes the selective permeability for inter-system agent access.

- relates_to::[[Vocabulary Lifecycle Through Tending]]↑
  - Uni-Versum's vocabulary is the most formally specified vocabulary system the estate has encountered. The two-tier approach (schema meta-vocabulary + domain vocabulary) provides a model for the garden's own vocabulary lifecycle.
