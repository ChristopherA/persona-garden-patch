...
- Allen, C. (2023). "Origins of Self-Sovereign Identity" — history of sovereignty, Living Systems Theory, membrane metaphor
...
- Allen, C. (2025). "How My Values Inform Design" — selective permeability as identity model, values-to-deployment pipeline
- Allen, C. (2025). "The Gordian Club" — autonomous cryptographic objects as membrane implementation
- Allen, C. (2016). "Defining Participatory Ecosystem" — ecosystem conditions as membrane specifications
- Miller, J. G. (1978). *Living Systems* — boundary as defining feature of living systems
- Allen, C. & Appelcline, S. (2019). *Meeples Together* — agency in cooperative play as membrane integrity

## Relations

- grounds::[[Authority Flows from the Person]] — principal authority is the governance logic of the membrane: authority flows outward from the sovereign self, not inward from systems
- relates_to::[[Authentic Collaboration Requires Agency]] — collaboration requires intact membranes; compliance results when membranes are breached
